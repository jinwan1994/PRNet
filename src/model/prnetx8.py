...
class PRNetx8(nn.Module):
    def __init__(self, args, conv=common.default_conv):
        super(PRNetx8, self).__init__()
        ...
        m_head_1 =[
            common.firstLayer_8(conv, n_feats, act=False)
        ]
        ...
        # define tail module
        m_tail = [
            common.reconstruction_8(conv, n_feats, kernel_size, act=False)
